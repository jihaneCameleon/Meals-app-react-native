...
const MealDetailScreen = props =>{
    ...
    const currentIsFavoriteMeals=useSelector(state=>state.meals.favoriteMeals.some(meal=>meal.id===mealId))
    ...
    return(
        <ScrollView>
            ...
            {selectedMeal.steps.map(ingredient=><ListItem key={ingredient} >
                {ingredient}
            </ListItem>)}
        </ScrollView>
    )
